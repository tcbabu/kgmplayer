...
EXTRALIBS          =  -Wl,--version-script,binary.ver -Wl,-z,noexecstack  -L/home/kulina/BUILD/kgmplayer/lib    -lncurses -lrt -L/home/kulina/BUILD/kgmplayer/lib -lgnutls -lpng -lz -ljpeg -lasound   -L/home/kulina/BUILD/kgmplayer/lib -ldvdread -L/home/kulina/BUILD/kgmplayer/lib -lfreetype  -lass -lvdpau -lfreetype  -lz -lbz2 -lmad -lvorbisenc -lvorbis -logg -L/home/kulina/BUILD/kgmplayer/lib -lopus   -rdynamic -lm  
EXTRALIBS_MPLAYER  =  -lXss -lXv -lXinerama -lXxf86vm -lXxf86dga
...
CONFIG_MPEG2_MEDIACODEC_HWACCEL = no
CONFIG_MPEG4_CUVID_HWACCEL = no
CONFIG_MPEG4_MEDIACODEC_HWACCEL = no
...
CONFIG_VP8_CUVID_HWACCEL = no
CONFIG_VP8_MEDIACODEC_HWACCEL = no
CONFIG_VP8_QSV_HWACCEL = no
CONFIG_VP9_CUVID_HWACCEL = no
CONFIG_VP9_D3D11VA_HWACCEL = no
CONFIG_VP9_D3D11VA2_HWACCEL = no
CONFIG_VP9_DXVA2_HWACCEL = no
CONFIG_VP9_MEDIACODEC_HWACCEL = no
...
CONFIG_ABENCH_FILTER = no
CONFIG_ACOMPRESSOR_FILTER = no
CONFIG_ACOPY_FILTER = no
CONFIG_ACROSSFADE_FILTER = no
CONFIG_ACRUSHER_FILTER = no
...
CONFIG_CROSSFEED_FILTER = no
CONFIG_CRYSTALIZER_FILTER = no
...
CONFIG_FIREQUALIZER_FILTER = no
CONFIG_FLANGER_FILTER = no
CONFIG_HAAS_FILTER = no
CONFIG_HDCD_FILTER = no
CONFIG_HEADPHONE_FILTER = no
CONFIG_HIGHPASS_FILTER = no
CONFIG_JOIN_FILTER = no
CONFIG_LADSPA_FILTER = no
CONFIG_LOUDNORM_FILTER = no
...
CONFIG_SUPEREQUALIZER_FILTER = no
CONFIG_SURROUND_FILTER = no
...
CONFIG_HWDOWNLOAD_FILTER = no
CONFIG_HWMAP_FILTER = no
CONFIG_HWUPLOAD_FILTER = no
CONFIG_HWUPLOAD_CUDA_FILTER = no
CONFIG_HYSTERESIS_FILTER = no
...
CONFIG_LIBVMAF_FILTER = no
CONFIG_LIMITER_FILTER = no
CONFIG_LOOP_FILTER = no
CONFIG_LUMAKEY_FILTER = no
CONFIG_LUT_FILTER = no
CONFIG_LUT2_FILTER = no
CONFIG_LUT3D_FILTER = no
CONFIG_LUTRGB_FILTER = no
CONFIG_LUTYUV_FILTER = no
CONFIG_MASKEDCLAMP_FILTER = no
CONFIG_MASKEDMERGE_FILTER = no
CONFIG_MCDEINT_FILTER = no
CONFIG_MERGEPLANES_FILTER = no
CONFIG_MESTIMATE_FILTER = no
CONFIG_METADATA_FILTER = no
CONFIG_MIDEQUALIZER_FILTER = no
CONFIG_MINTERPOLATE_FILTER = no
CONFIG_MPDECIMATE_FILTER = no
CONFIG_NEGATE_FILTER = no
CONFIG_NLMEANS_FILTER = no
...
CONFIG_PIXSCOPE_FILTER = no
CONFIG_PP_FILTER = no
CONFIG_PP7_FILTER = no
CONFIG_PREMULTIPLY_FILTER = no
CONFIG_PREWITT_FILTER = no
CONFIG_PSEUDOCOLOR_FILTER = no
CONFIG_PSNR_FILTER = no
CONFIG_PULLUP_FILTER = no
CONFIG_QP_FILTER = no
CONFIG_RANDOM_FILTER = no
CONFIG_READEIA608_FILTER = no
CONFIG_READVITC_FILTER = no
CONFIG_REALTIME_FILTER = no
CONFIG_REMAP_FILTER = no
CONFIG_REMOVEGRAIN_FILTER = no
CONFIG_REMOVELOGO_FILTER = no
CONFIG_REPEATFIELDS_FILTER = no
CONFIG_REVERSE_FILTER = no
CONFIG_ROBERTS_FILTER = no
CONFIG_ROTATE_FILTER = no
CONFIG_SAB_FILTER = no
CONFIG_SCALE_FILTER = no
CONFIG_SCALE_CUDA_FILTER = no
CONFIG_SCALE_NPP_FILTER = no
CONFIG_SCALE_QSV_FILTER = no
CONFIG_SCALE_VAAPI_FILTER = no
...
CONFIG_SIDEDATA_FILTER = no
CONFIG_SIGNALSTATS_FILTER = no
CONFIG_SIGNATURE_FILTER = no
CONFIG_SMARTBLUR_FILTER = no
CONFIG_SOBEL_FILTER = no
...
CONFIG_YUVTESTSRC_FILTER = no
CONFIG_NULLSINK_FILTER = no
CONFIG_ABITSCOPE_FILTER = no
