...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr --enable-static --disable-shared --enable-gpl --enable-postproc --enable-filter=volumedetect --disable-doc --enable-libmp3lame --enable-version3 --enable-gmp --enable-gnutls --disable-libxcb --enable-libx265 --enable-libx264 --disable-vaapi --enable-nonfree --enable-libfdk-aac --enable-avfilter --extra-libs='-lgnutls -lgnutlsxx -lnettle -lhogweed -lgmp -lfdk-aac'
prefix=/usr
...
CFLAGS=-fPIC -I/home/kulina/BUILD/kgmplayer/include -I/home/kulina/BUILD/kgmplayer/include/freetype2 -I/home/kulina/BUILD/kgmplayer/include    -std=c11 -fomit-frame-pointer -fPIC -pthread -I/home/kulina/BUILD/kgmplayer/include -I/home/kulina/BUILD/kgmplayer/include -I/home/kulina/BUILD/kgmplayer/include -I/home/kulina/BUILD/kgmplayer/include -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS=-L/home/kulina/BUILD/kgmplayer/lib  -lX11   -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
