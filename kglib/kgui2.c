...
//  sscanf(buff,"%d%d%d",&(t->row),&(t->col),&(t->bordr));
  ...
  void Print_data_buttonboxnew ( FILE *fp , DIBN *b ) {
      ...
      fprintf ( fp , "%d //Width \n" , b->width ) ;
      fprintf ( fp , "%d %d  //Nx,Ny,\n" , b->nx , b->ny ) ;
      if ( b->prompt != NULL ) fprintf ( fp , "\"%-s\"/Prompt\n" , b->prompt ) ;
      else fprintf ( fp , "NULL  //Prompt\n" ) ;
      n = b->nx*b->ny;
      for ( i = 0;i < n;i++ ) {
          fprintf ( fp , "\"%-s\" //title\n" , b->titles [ i ] ) ;
...
//  t->df = (int *)tmp;
  ...
  DILN * kgCreateHButtons ( int xo , int yo , int nx , int length , int height , char **titles , char *name )  \
      ...
      DILN htmp = {'H' , 10L , 10L , 0 , 0 , 5 , 5 , 50 , 25 , 1 , 1 , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , 2 , 0.2 , 0 , 0};
  ...
  DIB * kgCreateButtonsb ( int xo , int yo , int nx , int ny , int length , int height , char **titles , char *name )  \
      ...
      DIB htmp = {'b' , 10L , 10L , 60 , 20 , 5 , 5 , 52 , 52 , 1 , 1 , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , 2 , 0.2 , 0 , 0 , -1};
  ...
  DIN * kgCreateButtons ( int xo , int yo , int nx , int ny , int length , int height , char **titles , char *name )  \
      ...
      int clr = -1;
      int xgap = 4 , ygap = 4 , lngth = 80 , width = 25 , nxb = 1 , nyb = 1;
      DIN htmp = {'n' , 10L , 10L , 60 , 20 , 5 , 5 , 52 , 52 , 1 , 1 , 7 , 0.15 , 0 , 0 , 0 , 1 , NULL , NULL , NULL};
  ...
  DIL * kgCreateSplButtons ( int xo , int yo , int nx , int ny , int length , int height , char **titles , char *name )  \
      ...
      int clr = -1;
      int xgap = 4 , ygap = 4 , lngth = 80 , width = 25 , nxb = 1 , nyb = 1;
      DIL htmp = {'h' , 10L , 10L , 60 , 20 , 5 , 5 , 52 , 52 , 1 , 1 , 7 , 0.15 , 0 , 0 , 0 , 1 , NULL , NULL , NULL};
