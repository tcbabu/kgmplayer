...
int _ui_setattrib(void *parent,int xo,int yo,  void *v0, void *v1, void *v2, void *v3, 
 void *v4, void *v5, void *v6, void *v7, void *v14 ){
  ...
  DIA d[3];
  T_ELMT e0[9]  = { 
    {"Line Style     %2d", v0, 1,0,NULL},
    {"Line color     %2d", v1, 1,0,NULL},
    {"Line Width     %2d", v2, 1,0,NULL},
    {"Marker Type    %2d", v3, 1,0,NULL},
    {"Wipe/Fill color%2d", v4, 1,0,NULL},
    {"Text color     %2d", v5, 1,0,NULL},
    {"Text font      %2d", v6, 1,0,NULL},
    {"Text angle     %3d", v7, 1,0,NULL},
//    {"Text bold      %2d", v8, 1},
//    {"Text prop.     %2d", v9, 1},
//    {"Text fill      %2d", v10, 1},
//    {"Text bodr      %2d", v11, 1},
...
int kgAttibDia( void *parent ,void *v0 ,void *v1 ,void *v2 ,void *v3 
 ...
 ,void *v9 ,void *v10 ,void *v11 ,void *v12 ,void *v13 ,void *ptrs) {
  int ret=1;
  DIALOG D;
  DIA d[16];
  T_ELMT e0[1]  = { 
  ...
  DIT t0 = { 
    ...
    e0,
    1,1,
    NULL,kgAttibDiatextbox1callback /* args,Call back */
  };
  t0.type=0;
  char *titles1[]  = { 
    (char *)"Select", 
  ...
  DIB n1 = { 
    ...
    titles1,
    butncode1,
    NULL,kgAttibDiabutnbox1callback, /* args, Callbak */
    xpm1,bkgr1, /* pointers to xpms and colors */
  ...
  DIT t2 = { 
    ...
    e2,
    1,1,
    NULL,kgAttibDiatextbox2callback /* args,Call back */
  };
  t2.type=0;
  char *titles3[]  = { 
    (char *)"Select", 
  ...
  DIB n3 = { 
    ...
    titles3,
    butncode3,
    NULL,kgAttibDiabutnbox2callback, /* args, Callbak */
  ...
  DIT t4 = { 
    ...
    e4,
    1,1,
    NULL,kgAttibDiatextbox3callback /* args,Call back */
  };
  t4.type=0;
  T_ELMT e5[1]  = { 
  ...
  DIT t5 = { 
    ...
    e5,
    1,1,
    NULL,kgAttibDiatextbox4callback /* args,Call back */
  };
  t5.type=0;
  char *titles6[]  = { 
    (char *)"Select", 
  ...
  DIB n6 = { 
    ...
    titles6,
    butncode6,
    NULL,kgAttibDiabutnbox3callback, /* args, Callbak */
    xpm6,bkgr6, /* pointers to xpms and colors */
      2,0.200000 /* button type and roundinfg factor(0-0.5) */
  };
  char *titles7[]  = { 
  ...
  DIB n7 = { 
    ...
    titles7,
    butncode7,
    NULL,kgAttibDiabutnbox4callback, /* args, Callbak */
  ...
  DIT t8 = { 
    ...
    e8,
    1,1,
    NULL,kgAttibDiatextbox5callback /* args,Call back */
  };
  t8.type=0;
  char *titles9[]  = { 
    (char *)"Select", 
  ...
  DIB n9 = { 
    ...
    titles9,
    butncode9,
    NULL,kgAttibDiabutnbox5callback, /* args, Callbak */
    xpm9,bkgr9, /* pointers to xpms and colors */
      2,0.200000 /* button type and roundinfg factor(0-0.5) */
  };
  char *menu10[]  = { 
  ...
  DIW w10 = { 
    ...
    (char *)"Line Style" ,
    menu10 ,
    NULL,kgAttibDiabrowser1callback /* *args, callback */
  };
  char *menu11[]  = { 
  ...
  DIW w11 = { 
    ...
    (char *)"Line Width" ,
    menu11 ,
    NULL,kgAttibDiabrowser2callback /* *args, callback */
  };
  char *menu12[]  = { 
  ...
  DIW w12 = { 
    ...
    (char *)"Marker Type" ,
    menu12 ,
    NULL,kgAttibDiabrowser3callback /* *args, callback */
  };
  char *menu13[]  = { 
    (char *)"0", (char *)"10", (char *)"20", (char *)"30", (char *)"40",
    (char *)"50", (char *)"60", (char *)"70", (char *)"80", (char *)"90",
    (char *)"100", (char *)"110", (char *)"120", (char *)"130", (char *)"140",
    (char *)"150", (char *)"160", (char *)"170", (char *)"180", (char *)"190",
    (char *)"200", (char *)"210", (char *)"220", (char *)"230", (char *)"240",
    (char *)"250", (char *)"260", (char *)"270", (char *)"280", (char *)"290",
    (char *)"300", (char *)"310", (char *)"320", (char *)"330", (char *)"340",
    (char *)"350",
    NULL 
  };
  DIW w13 = { 
    ...
    (char *)"Text Angle" ,
    menu13 ,
    NULL,kgAttibDiabrowser4callback /* *args, callback */
  };
  int butn1 =1;
  int sw14[1]  = { 
    1  
  ...
  DILN H14 = { 
    ...
    titles14,
    butncode14,
    NULL,kgAttibDiahoribar1callback,/* arg, Callbak */
...
*************************************************/
   ...
   pt[0]=G;
   pt[1]=&count;
   kgAttibDia(NULL ,&v0 ,&v1 ,&v2 ,&v3 
     ,&v4 ,&v5 ,&v6 ,&v7 ,&v8 
     ,&v9 ,&v10 ,&v11 ,&v12 ,&v13 ,(void *)pt);
   LnStyle = v10-1;
   LnWidth = v11;
   MarkType=v12-1;
   TextAngle = (v13-1)*10;
...
int getfact(void *parent,  void *v0, void *v1, void *v2 ){
  ...
  DIA d[3];
  T_ELMT e0[3]  = { 
    {"Mul. fac for height%12F", v0, 1,0,NULL},
    {"Mul. fac for width %12F", v1, 1,0,NULL},
...
void  kgDrawingTool(DIG *G)

  {
      ...
      char *cmenu[]={ "Move","Draw","Arrow","Rectgl",
                    "Text","txtSize", "Undo","Wipe","polyfiL", "atrIbts",
                    "arC","rhomBus", "marK","rePeat","bOrder",
                    "arc_Fill","Quit",NULL};
      ...
      parent = G->D;
      if( dc->A_size >10) A_fac=(float) (dc->A_size/10)/(dc->A_size%10);
      tgg=0;
                 ...
                 if ( key== 'u'){
                                 if(count >1)
                                    { loc--;count--;
                                      uiupdate_intr(G,count,dc->cmds);
                                      uiupdate_view(G);} }
                 else { kgMove2f(G,xx,yy);kgDraw2f(G,xx,y),kgDraw2f(G,x,y);
                        kgDraw2f(G,x,yy),kgDraw2f(G,xx,yy);
                       *(loc++)=50;count++;}   
                }
               kgMove2f(G,xx,yy);kgDraw2f(G,xx,y),kgDraw2f(G,x,y),kgDraw2f(G,x,yy),
               kgDraw2f(G,xx,yy);
               xo=xx-x;yo=yy-y;
               last='r';
               *(loc++)=50;count++;  
...
//    NULL,Show_Filehoribar1callback,/* arg, Callbak */
  ...
  while(butns[item]!=NULL){
    l = strlen(butns[item]); if(l>nchars) nchars=l;sw1[item]=1;item++;
  }
...
int kgPickImage( void *parent,int xo,int yo,void *pt) {
  ...
  DIY y1 = { 
    ...
    NULL, 
    NULL, 
    NULL,PickImagebrowser2callback, /* *args, callback */
    12,  /* Border Offset  */
     22,  /* Scroll width  */
     1,  /* Type  */
     1, /* item highlight */
...
(char *)"##" , // Pixmap info
  ...
  DIB n2 = { 
    ...
    titles2,
    butncode2,
    NULL,PickImagebutnbox1callback, /* args, Callbak */
    xpm2,bkgr2, /* pointers to xpms and colors */
      4,0.200000,0,0 /* button type and roundinfg factor(0-0.5),bordr,hide */
  };
  int butn1 =1;
  int sw3[3]  = { 
    1, 
  ...
  DILN H3 = { 
    ...
    titles3,
    butncode3,
    NULL,PickImagehoribar1callback,/* arg, Callbak */
    xpm3,bkgr3, /* pointers to xpms and colors */
