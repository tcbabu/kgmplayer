...
int keybrd4Group( DIALOG *D,void **v,void *pt) {
  ...
  DIN b4 = { 
    ...
    butn4, 
    keybrd4button1callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b5 = { 
    ...
    butn5, 
    keybrd4button2callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b6 = { 
    ...
    butn6, 
    keybrd4button3callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b7 = { 
    ...
    butn7, 
    keybrd4button4callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  butn8[0].sw=1;
  strcpy(butn8[0].title,(char *)"Shift");
  butn8[0].xpmn=NULL;
  butn8[0].xpmp=NULL;
  butn8[0].xpmh=NULL;
  butn8[0].bkgr=-1;
  ...
  DIN b8 = { 
    ...
    butn8, 
    keybrd4button5callback, /*  Callbak */
      NULL  /* any args */
  };
  strcpy(b8.Wid,(char *)"Shift");
  b8.item = -1;
  BUT_STR  *butn9=NULL; 
  butn9= (BUT_STR *)Malloc(sizeof(BUT_STR)*1);
  butn9[0].sw=1;
  strcpy(butn9[0].title,(char *)"Left");
  butn9[0].xpmn=NULL;
  butn9[0].xpmp=NULL;
  butn9[0].xpmh=NULL;
  butn9[0].bkgr=-1;
  ...
  DIN b9 = { 
    ...
    butn9, 
    keybrd4button6callback, /*  Callbak */
      NULL  /* any args */
  };
  strcpy(b9.Wid,(char *)"Left");
  b9.item = -1;
  BUT_STR  *butn10=NULL; 
  butn10= (BUT_STR *)Malloc(sizeof(BUT_STR)*2);
  butn10[0].sw=1;
  strcpy(butn10[0].title,(char *)"Home");
  butn10[0].xpmn=NULL;
  butn10[0].xpmp=NULL;
  butn10[0].xpmh=NULL;
  butn10[0].bkgr=-1;
  butn10[0].butncode='';
  butn10[1].sw=1;
  strcpy(butn10[1].title,(char *)"End");
  butn10[1].xpmn=NULL;
  butn10[1].xpmp=NULL;
  butn10[1].xpmh=NULL;
  butn10[1].bkgr=-1;
  ...
  DIN b10 = { 
    ...
    butn10, 
    keybrd4button7callback, /*  Callbak */
      NULL  /* any args */
  };
  strcpy(b10.Wid,(char *)"End");
  b10.item = -1;
  BUT_STR  *butn11=NULL; 
  ...
  DIN b11 = { 
    ...
    butn11, 
    keybrd4button8callback, /*  Callbak */
      NULL  /* any args */
  };
  strcpy(b11.Wid,(char *)"SpacBar");
  b11.item = -1;
  BUT_STR  *butn12=NULL; 
  ...
  DIN b12 = { 
    ...
    butn12, 
    keybrd4button9callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b13 = { 
    ...
    butn13, 
    keybrd4button10callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b14 = { 
    ...
    butn14, 
    keybrd4button11callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b15 = { 
    ...
    butn15, 
    keybrd4button12callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b16 = { 
    ...
    butn16, 
    keybrd4button13callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b17 = { 
    ...
    butn17, 
    keybrd4button14callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b18 = { 
    ...
    butn18, 
    keybrd4button15callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b19 = { 
    ...
    butn19, 
    keybrd4button16callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b20 = { 
    ...
    butn20, 
    keybrd4button17callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b21 = { 
    ...
    butn21, 
    keybrd4button18callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b22 = { 
    ...
    butn22, 
    keybrd4button19callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b23 = { 
    ...
    butn23, 
    keybrd4button20callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b24 = { 
    ...
    butn24, 
    keybrd4button21callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIN b25 = { 
    ...
    butn25, 
    keybrd4button22callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  dtmp = (DIA *)realloc(dtmp,sizeof(DIA )*(i+27));
  d =dtmp+i; 
  d[26].t=NULL;
  ...
  *d[4].N = b4;
  ...
  keybrd4button1init(d[4].N,pt) ;
  d[5].t = (DIT *)Malloc(sizeof(DIN));
  *d[5].N = b5;
  d[5].N->item = -1;
  keybrd4button2init(d[5].N,pt) ;
  d[6].t = (DIT *)Malloc(sizeof(DIN));
  *d[6].N = b6;
  d[6].N->item = -1;
  keybrd4button3init(d[6].N,pt) ;
  d[8].t = (DIT *)Malloc(sizeof(DIN));
  *d[8].N = b8;
  d[7].t = (DIT *)Malloc(sizeof(DIN));
  *d[7].N = b7;
  d[7].N->item = -1;
  keybrd4button4init(d[7].N,pt) ;
  d[8].N->item = -1;
  keybrd4button5init(d[8].N,pt) ;
  d[9].t = (DIT *)Malloc(sizeof(DIN));
  *d[9].N = b9;
  d[9].N->item = -1;
  keybrd4button6init(d[9].N,pt) ;
  d[10].t = (DIT *)Malloc(sizeof(DIN));
  *d[10].N = b10;
  d[10].N->item = -1;
  keybrd4button7init(d[10].N,pt) ;
  d[11].t = (DIT *)Malloc(sizeof(DIN));
  *d[11].N = b11;
  d[11].N->item = -1;
  keybrd4button8init(d[11].N,pt) ;
  d[12].t = (DIT *)Malloc(sizeof(DIN));
  *d[12].N = b12;
  d[12].N->item = -1;
  keybrd4button9init(d[12].N,pt) ;
  d[13].t = (DIT *)Malloc(sizeof(DIN));
  *d[13].N = b13;
  d[13].N->item = -1;
  keybrd4button10init(d[13].N,pt) ;
  d[14].t = (DIT *)Malloc(sizeof(DIN));
  *d[14].N = b14;
  d[14].N->item = -1;
  keybrd4button11init(d[14].N,pt) ;
  d[15].t = (DIT *)Malloc(sizeof(DIN));
  *d[15].N = b15;
  d[15].N->item = -1;
  keybrd4button12init(d[15].N,pt) ;
  d[16].t = (DIT *)Malloc(sizeof(DIN));
  *d[16].N = b16;
  d[16].N->item = -1;
  keybrd4button13init(d[16].N,pt) ;
  d[17].t = (DIT *)Malloc(sizeof(DIN));
  *d[17].N = b17;
  d[17].N->item = -1;
  keybrd4button14init(d[17].N,pt) ;
  d[18].t = (DIT *)Malloc(sizeof(DIN));
  *d[18].N = b18;
  d[18].N->item = -1;
  keybrd4button15init(d[18].N,pt) ;
  d[19].t = (DIT *)Malloc(sizeof(DIN));
  *d[19].N = b19;
  d[19].N->item = -1;
  keybrd4button16init(d[19].N,pt) ;
  d[20].t = (DIT *)Malloc(sizeof(DIN));
  *d[20].N = b20;
  d[20].N->item = -1;
  keybrd4button17init(d[20].N,pt) ;
  d[21].t = (DIT *)Malloc(sizeof(DIN));
  *d[21].N = b21;
  d[21].N->item = -1;
  keybrd4button18init(d[21].N,pt) ;
  d[22].t = (DIT *)Malloc(sizeof(DIN));
  *d[22].N = b22;
  d[22].N->item = -1;
  keybrd4button19init(d[22].N,pt) ;
  d[23].t = (DIT *)Malloc(sizeof(DIN));
  *d[23].N = b23;
  d[23].N->item = -1;
  keybrd4button20init(d[23].N,pt) ;
  d[24].t = (DIT *)Malloc(sizeof(DIN));
  *d[24].N = b24;
  d[24].N->item = -1;
  keybrd4button21init(d[24].N,pt) ;
  d[25].t = (DIT *)Malloc(sizeof(DIN));
  *d[25].N = b25;
  d[25].N->item = -1;
  keybrd4button22init(d[25].N,pt) ;
  d[26].t = NULL;
  GrpId=kgOpenGrp(D);
  D->d = dtmp;
  j=0;
...
int kgMakeKeybrd4(DIALOG *D,int Bx,int By,int Xg,int Yg,int Vis,int btype,int bfont,int fontclr,int butclr,int bkgrclr,float rfac,float transparency,int bodr,float Brfac) {
   ...
   if(Kbrd->Btype < 1) {
     ...
     Kbrd->Thds = Thds;
     GrpId = keybrd4Group(D,v,Kbrd);
     WaitThreads(Thds);
     CloseThreads(Thds);
     Kbrd->Thds= NULL;
#else
     GrpId = keybrd4Group(D,v,pt);
#endif
   }
   else {
     GrpId = keybrd4Group(D,v,pt);
   ...
   Modifykeybrd4(D,offset);    /*  add extras to  gui*/
   Gpt = kgGetWidgetGrp(D,GrpId);
   kgSetGrpCleanup(D,GrpId,keybrd4cleanup);
...
int keybrd4( void *parent,void **v,void *pt) {
  int ret=1,GrpId,k;
  DIALOG D;
  DIA *d=NULL;
  D.VerId=2107030000;
  ...
  GrpId = keybrd4Group(&D,v,pt);
#else 
  GrpId = Makekeybrd4Group(&D,pt); // can try this also
#endif 
  d = D.d;
  D.d = d;
  ...
  D.yo = 10;
  D.xl = 616;    /*  Length of Dialog */
  D.yl = 231;    /*  Width  of Dialog */
  D.Initfun = keybrd4init;    /*   init fuction for Dialog */
  D.Cleanupfun = keybrd4cleanup;    /*   init fuction for Dialog */
...
#if 1 
  D.Callback = keybrd4CallBack;    /*  default callback */
#else 
  D.Callback = NULL;    
#endif
  D.ResizeCallback = keybrd4ResizeCallBack;  /*  Resize callback */
#if 0 
  D.WaitCallback = NULL;  /*  Wait callback */
#else 
  D.WaitCallback = keybrd4WaitCallBack;  /*  Wait callback */
#endif
...
//  Modifykeybrd4Gc(&(D.gc));    /*  set colors for gui*/
  Modifykeybrd4(&D,0);    /*  add extras to  gui*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
void *Runkeybrd4(void *arg) {
/*************************************************
