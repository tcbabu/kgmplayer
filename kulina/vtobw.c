...
int vtobwGroup( DIALOG *D,void **v,void *pt) {
  ...
  DIT t0 = { 
    ...
    e0,
    1,1,
    NULL,vtobwtextbox1callback,1,0,18,9 /* args,Call back */
  };
  strcpy(t0.Wid,(char *)"v2bwInput");
  t0.pt=NULL;
  t0.type = 0;
  t0.item = -1;
  T_ELMT *e1  ; 
  ...
  DIT t1 = { 
    ...
    e1,
    1,1,
    NULL,vtobwtextbox2callback,1,0,18,9 /* args,Call back */
  };
  strcpy(t1.Wid,(char *)"v2bwOutput");
  t1.pt=NULL;
  t1.type = 0;
  t1.item = -1;
  BUT_STR  *butn2=NULL; 
  ...
  DIL h3 = { 
    ...
    butn3, 
    vtobwsplbutton1callback, /*  Callbak */
      NULL  /* any args */
  };
  strcpy(h3.Wid,(char *)"normalizeWidget12");
  h3.item = -1;
  DII i4 = { 
    'i',
    27,125,  
  ...
  strcpy(i4.Wid,(char *)"v2bwInfoBox");
  i4.item = -1;
  DIM m5 = { 
    'm',
    22,23,  
  ...
  strcpy(m5.Wid,(char *)"vtobwWidget6");
  m5.item = -1;
  DIM m6 = { 
    'm',
    17,57,  
  ...
  strcpy(m6.Wid,(char *)"vtobwWidget7");
  m6.item = -1;
  dtmp = D->d;
  i=0;
  ...
  *d[1].t = t1;
  ...
  vtobwbutton1init(&b2,pt) ;
  *d[2].N = b2;
  d[2].N->item = -1;
  d[3].t = (DIT *)malloc(sizeof(DIL));
  vtobwsplbutton1init(&h3,pt) ;
  *d[3].h = h3;
  d[3].h->item = -1;
...
int vtobw( void *parent,void **v,void *pt) {
  ...
  D.Cleanupfun = vtobwcleanup;    /*   init fuction for Dialog */
...
//  ModifyvtobwGc(&(D.gc));    /*  set colors for gui*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
void *Runvtobw(void *arg) {
/*************************************************
