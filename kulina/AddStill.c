...
#include "GclrAddStill.c"
int AddStillGroup( DIALOG *D,void **v,void *pt) {
  ...
  DIT t0 = { 
    ...
    e0,
    1,1,
    NULL,AddStillASVinputcallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t0.Wid,(char *)"ASVinput");
  t0.pt=NULL;
  t0.type = 1;
  t0.item = -1;
  BUT_STR  *butn1=NULL; 
  ...
  DIN b1 = { 
    ...
    butn1, 
    AddStillASVinputbrowsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b1.Wid,(char *)"ASVinputbrowse");
  b1.item = -1;
  BUT_STR  *butn2=NULL; 
  ...
  DIL h2 = { 
    ...
    butn2, 
    AddStillASVgocallback ,  /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(h2.Wid,(char *)"ASVgo");
  h2.item = -1;
  DII i3 = { 
    'i',
    55,239,  
  ...
  DIT t4 = { 
    ...
    e4,
    1,1,
    NULL,AddStillASVoutcallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t4.Wid,(char *)"ASVout");
  t4.pt=NULL;
  t4.type = 1;
  t4.item = -1;
  BUT_STR  *butn5=NULL; 
  ...
  DIN b5 = { 
    ...
    5,0.150000,0,0,0,1,/* button type and roundinfg factor(0-0.5),bordr,hide ,nodrawbkgr*/ 
    butn5, 
    AddStillASVOutbrowsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b5.Wid,(char *)"ASVOutbrowse");
  b5.item = -1;
  T_ELMT *e6  ; 
  ...
  DIT t6 = { 
    ...
    e6,
    1,1,
    NULL,AddStillASVdurcallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t6.Wid,(char *)"ASVdur");
  t6.pt=NULL;
  t6.type = 0;
  t6.item = -1;
  dtmp = D->d;
  ...
  *d[1].N = b1;
  d[1].N->item = -1;
  AddStillASVinputbrowseinit(d[1].N,pt) ;
  d[2].t = (DIT *)malloc(sizeof(DIL));
  *d[2].h = h2;
  d[2].h->item = -1;
  AddStillASVgoinit(d[2].h,pt) ;
  ...
  *d[5].N = b5;
  d[5].N->item = -1;
  AddStillASVOutbrowseinit(d[5].N,pt) ;
...
int AddStill( void *parent,void **v,void *pt) {
  int ret=1,GrpId,k;
  DIALOG D;
  DIA *d=NULL;
  D.VerId=2107030000;
  ...
  GrpId = AddStillGroup(&D,v,pt);
#else 
  GrpId = MakeAddStillGroup(&D,pt); // can try this also
#endif 
  d = D.d;
  D.d = d;
  ...
  D.Initfun = AddStillinit;    /*   init fuction for Dialog */
  D.Cleanupfun = AddStillcleanup;    /*   cleanup fuction for Dialog */
...
#if 1 
  D.Callback = AddStillCallBack;    /*  default Callback  */
#else 
  D.Callback = NULL;    
#endif
  D.ResizeCallback = AddStillResizeCallBack;  /*  Resize callback */
#if 0 
  D.WaitCallback = NULL;  /*  Wait callback */
#else 
  D.WaitCallback = AddStillWaitCallBack;  /*  Wait callback */
#endif
...
//     D.StackPos = 1; // you may need it
  ...
  ModifyAddStillGc(&D);    /*  set colors for gui if do not like default*/
  ModifyAddStill(&D,GrpId);    /*  add extras to  gui*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
void *RunAddStill(void *parent ,void *args) {
/*************************************************
