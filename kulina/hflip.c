...
int hflipGroup( DIALOG *D,void **v,void *pt) {
  ...
  DIT t0 = { 
    ...
    e0,
    1,1,
    NULL,hfliptextbox1callback,1,0,18,9 /* args,Call back */
  };
  ...
  DIT t1 = { 
    ...
    e1,
    1,1,
    NULL,hfliptextbox2callback,1,0,18,9 /* args,Call back */
  };
  strcpy(t1.Wid,(char *)"hflipOutput");
  t1.pt=NULL;
  t1.type = 0;
  t1.item = -1;
  BUT_STR  *butn2=NULL; 
  ...
  DIN b2 = { 
    ...
    butn2, 
    hflipbutton1callback, /*  Callbak */
      NULL  /* any args */
  };
  strcpy(b2.Wid,(char *)"hflipWidget1");
  b2.item = -1;
  BUT_STR  *butn3=NULL; 
  butn3= (BUT_STR *)malloc(sizeof(BUT_STR)*1);
  butn3[0].sw=1;
  strcpy(butn3[0].title,(char *)"!f23Do it");
  butn3[0].xpmn=NULL;
  butn3[0].xpmp=NULL;
  butn3[0].xpmh=NULL;
  ...
  strcpy(h3.Wid,(char *)"hflipWidget2");
  h3.item = -1;
  DII i4 = { 
    'i',
    27,125,  
  ...
  strcpy(i4.Wid,(char *)"hflipInfoBox");
  i4.item = -1;
  DIM m5 = { 
    'm',
    22,23,  
  ...
  strcpy(m5.Wid,(char *)"hflipWidget3");
  m5.item = -1;
  DIM m6 = { 
    'm',
    17,57,  
  ...
  strcpy(m6.Wid,(char *)"hflipWidget4");
  m6.item = -1;
  dtmp = D->d;
  i=0;
  ...
  *d[1].t = t1;
  ...
  hflipbutton1init(&b2,pt) ;
  *d[2].N = b2;
  d[2].N->item = -1;
  d[3].t = (DIT *)malloc(sizeof(DIL));
  hflipsplbutton1init(&h3,pt) ;
  *d[3].h = h3;
  d[3].h->item = -1;
...
int hflip( void *parent,void **v,void *pt) {
  ...
  D.Cleanupfun = hflipcleanup;    /*   init fuction for Dialog */
...
//  ModifyhflipGc(&(D.gc));    /*  set colors for gui*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
void *Runhflip(void *arg) {
/*************************************************
