...
int textovervideoGroup( DIALOG *D,void **v,void *pt) {
  ...
  butn15[0].sw=1;
  strcpy(butn15[0].title,(char *)"Create/Edit Text file");
  butn15[0].xpmn=NULL;
  butn15[0].xpmp=NULL;
  butn15[0].xpmh=NULL;
  butn15[0].bkgr=-1;
  butn15[0].butncode=31;
  DIN b15 = { 
    'n',
    118,72,  
    363,102,
    ...
    5,0.500000,0,0,0,1,/* button type and roundinfg factor(0-0.5),bordr,hide ,nodrawbkgr*/ 
    butn15, 
    textovervideoTOVtcecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b15.Wid,(char *)"TOVtce");
  b15.item = -1;
  dtmp = D->d;
  i=0;
  ...
  *d[15].N = b15;
  d[15].N->item = -1;
  textovervideoTOVtceinit(d[15].N,pt) ;
  d[16].t = NULL;
  GrpId=kgOpenGrp(D);
  D->d = dtmp;
  j=0;
