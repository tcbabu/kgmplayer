...
// pt[0] is args passed as inputs; pt[1] is output pointer
  ...
  e = T->elmt;
  TO = (DIT *)kgGetNamedWidget(Tmp,(char *)"RSoutput");
...
// pt[0] is args passed as inputs; pt[1] is output pointer
  ...
  n = B->nx*B->ny;
  DIT *T,*TO;
  T = (DIT *)kgGetNamedWidget(Tmp,(char *)"RSinput");
  TO = (DIT *)kgGetNamedWidget(Tmp,(char *)"RSoutput");
  n = B->nx*B->ny;
  FileName[0]='\0';
  strcpy(FileName,kgGetString(T,0));
...
void  RangeSelectbutton1init(DIN *B,void *ptmp) {
...
// pt[0] is args passed as inputs; pt[1] is output pointer
  ...
  TI = (DIT *)kgGetNamedWidget(Tmp,(char *)"RSinput");
  TO = (DIT *)kgGetNamedWidget(Tmp,(char *)"RSoutput");
  
  DIT *Rmin,*Rmax;
  Rmin = (DIT *)kgGetNamedWidget(Tmp,(char *)"RSminimum");
  Rmax = (DIT *)kgGetNamedWidget(Tmp,(char *)"RSmaximum");
...
void  RangeSelectsplbutton1init(DIL *B,void *ptmp) {
 void **pt=(void **)ptmp; //pt[0] is arg 
// may use kgChangeButtonNormalImage etc...
 BUT_STR *buts;
 buts = (BUT_STR *) (B->buts);
...
// pt[0] is args passed as inputs; pt[1] is output pointer
 /* pt[0] is inputs, given by caller */
  DIT *Rmin,*Rmax;
  Rmin = (DIT *)kgGetNamedWidget(Tmp,(char *)"RSminimum");
  Rmax = (DIT *)kgGetNamedWidget(Tmp,(char *)"RSmaximun");
