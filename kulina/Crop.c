...
#include "GclrCrop.c"
int CropGroup( DIALOG *D,void **v,void *pt) {
  ...
  DIT t0 = { 
    ...
    e0,
    1,1,
    NULL,CropCRPinput1callback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t0.Wid,(char *)"CRPinput1");
  t0.pt=NULL;
  t0.type = 1;
  t0.item = -1;
  BUT_STR  *butn1=NULL; 
  ...
  DIN b1 = { 
    ...
    butn1, 
    CropCRPinput1browsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b1.Wid,(char *)"CRPinput1browse");
  b1.item = -1;
  BUT_STR  *butn2=NULL; 
  ...
  DIL h2 = { 
    ...
    butn2, 
    CropCRPgocallback ,  /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(h2.Wid,(char *)"CRPgo");
  h2.item = -1;
  DII i3 = { 
    'i',
    13,265,  
  ...
  DIT t4 = { 
    ...
    e4,
    1,1,
    NULL,CropCRPoutcallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t4.Wid,(char *)"CRPout");
  t4.pt=NULL;
  t4.type = 1;
  t4.item = -1;
  BUT_STR  *butn5=NULL; 
  ...
  DIN b5 = { 
    ...
    5,0.150000,0,0,0,1,/* button type and roundinfg factor(0-0.5),bordr,hide ,nodrawbkgr*/ 
    butn5, 
    CropCRPOutbrowsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b5.Wid,(char *)"CRPOutbrowse");
  b5.item = -1;
  T_ELMT *e6  ; 
  e6 =(T_ELMT *)malloc(sizeof(T_ELMT)*2);
  e6[0].fmt = (char *)malloc(14);
  strcpy(e6[0].fmt,(char *)"Crop  left%6d");
  e6[0].v=(void *)v[2];
  e6[0].sw=1;
  e6[0].noecho=0;
  e6[0].img=NULL;
  e6[1].fmt = (char *)malloc(10);
  strcpy(e6[1].fmt,(char *)"top   %6d");
  e6[1].v=(void *)v[3];
  e6[1].sw=1;
  e6[1].noecho=0;
  e6[1].img=NULL;
  DIT t6 = { 
    ...
    e6,
    1,1,
    NULL,CropCRPloccallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t6.Wid,(char *)"CRPloc");
  t6.pt=NULL;
  t6.type = 0;
  t6.item = -1;
  T_ELMT *e7  ; 
  e7 =(T_ELMT *)malloc(sizeof(T_ELMT)*2);
  e7[0].fmt = (char *)malloc(14);
  strcpy(e7[0].fmt,(char *)"Crop width%6d");
  e7[0].v=(void *)v[4];
  e7[0].sw=1;
  e7[0].noecho=0;
  e7[0].img=NULL;
  e7[1].fmt = (char *)malloc(10);
  strcpy(e7[1].fmt,(char *)"height%6d");
  e7[1].v=(void *)v[5];
  e7[1].sw=1;
  e7[1].noecho=0;
  e7[1].img=NULL;
  DIT t7 = { 
    ...
    e7,
    1,1,
    NULL,CropCRPrescallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t7.Wid,(char *)"CRPres");
  t7.pt=NULL;
  t7.type = 0;
  t7.item = -1;
  BUT_STR  *butn8=NULL; 
  ...
  butn8[0].sw=1;
  strcpy(butn8[0].title,(char *)"Select TOP POSITION");
  butn8[0].xpmn=NULL;
  butn8[0].xpmp=NULL;
  butn8[0].xpmh=NULL;
  butn8[0].bkgr=-1;
  ...
  DIN b8 = { 
    ...
    butn8, 
    CropCRPselectcallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b8.Wid,(char *)"CRPselect");
  b8.item = -1;
  dtmp = D->d;
  i=0;
  ...
  *d[1].N = b1;
  d[1].N->item = -1;
  CropCRPinput1browseinit(d[1].N,pt) ;
  d[2].t = (DIT *)malloc(sizeof(DIL));
  *d[2].h = h2;
  d[2].h->item = -1;
  CropCRPgoinit(d[2].h,pt) ;
...
*************************************************/
   ...
   *v5 = 1;
   ...
   GrpId = CropGroup(D,v,pt);
   Gpt = kgGetWidgetGrp(D,GrpId);
   Gpt->arg= v; // kulina will double free this; you may modify
   return GrpId;
}

int Crop( void *parent,void **v,void *pt) {
  int ret=1,GrpId,k;
  DIALOG D;
  DIA *d=NULL;
  D.VerId=2107030000;
  ...
  GrpId = CropGroup(&D,v,pt);
#else 
  GrpId = MakeCropGroup(&D,pt); // can try this also
#endif 
  d = D.d;
  D.d = d;
  ...
  D.Initfun = Cropinit;    /*   init fuction for Dialog */
  D.Cleanupfun = Cropcleanup;    /*   cleanup fuction for Dialog */
...
#if 1 
  D.Callback = CropCallBack;    /*  default Callback  */
#else 
  D.Callback = NULL;    
#endif
  D.ResizeCallback = CropResizeCallBack;  /*  Resize callback */
#if 0 
  D.WaitCallback = NULL;  /*  Wait callback */
#else 
  D.WaitCallback = CropWaitCallBack;  /*  Wait callback */
#endif
...
//     D.StackPos = 1; // you may need it
  ...
  ModifyCropGc(&D);    /*  set colors for gui if do not like default*/
  ModifyCrop(&D,GrpId);    /*  add extras to  gui*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
void *RunCrop(void *parent ,void *args) {
/*************************************************
