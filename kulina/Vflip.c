...
int VflipGroup( DIALOG *D,void **v,void *pt) {
  ...
  DIT t0 = { 
    ...
    e0,
    1,1,
    NULL,VflipVFLIPinputcallback ,0 ,0,18,9 
  };
  ...
  DIN b1 = { 
    ...
    butn1, 
    VflipVFLIPinputbrowsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b1.Wid,(char *)"VFLIPinputbrowse");
  b1.item = -1;
  BUT_STR  *butn2=NULL; 
  ...
  DIL h2 = { 
    ...
    butn2, 
    VflipVFLIPgocallback ,  /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(h2.Wid,(char *)"VFLIPgo");
  h2.item = -1;
  DII i3 = { 
    'i',
    13,180,  
  ...
  DIT t4 = { 
    ...
    e4,
    1,1,
    NULL,VflipVFLIPoutcallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t4.Wid,(char *)"VFLIPout");
  t4.pt=NULL;
  t4.type = 1;
  t4.item = -1;
  BUT_STR  *butn5=NULL; 
  ...
  DIN b5 = { 
    ...
    5,0.150000,0,0,0,1,/* button type and roundinfg factor(0-0.5),bordr,hide ,nodrawbkgr*/ 
    butn5, 
    VflipVFLIPOutbrowsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b5.Wid,(char *)"VFLIPOutbrowse");
  b5.item = -1;
  dtmp = D->d;
  i=0;
  ...
  *d[1].N = b1;
  d[1].N->item = -1;
  VflipVFLIPinputbrowseinit(d[1].N,pt) ;
  d[2].t = (DIT *)malloc(sizeof(DIL));
  *d[2].h = h2;
  d[2].h->item = -1;
  VflipVFLIPgoinit(d[2].h,pt) ;
  ...
  *d[5].N = b5;
  d[5].N->item = -1;
  VflipVFLIPOutbrowseinit(d[5].N,pt) ;
  d[6].t = NULL;
  GrpId=kgOpenGrp(D);
  D->d = dtmp;
  j=0;
...
int Vflip( void *parent,void **v,void *pt) {
  ...
  GrpId = VflipGroup(&D,v,pt);
#else 
  GrpId = MakeVflipGroup(&D,pt); // can try this also
#endif 
  d = D.d;
  D.d = d;
  ...
  D.Cleanupfun = Vflipcleanup;    /*   cleanup fuction for Dialog */
...
//     D.StackPos = 1; // you may need it
  ...
  ModifyVflipGc(&D);    /*  set colors for gui if do not like default*/
  ModifyVflip(&D,GrpId);    /*  add extras to  gui*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
void *RunVflip(void *parent ,void *args) {
/*************************************************
