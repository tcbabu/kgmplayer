...
int imgs2vGroup( DIALOG *D,void **v,void *pt) {
  ...
  DIN b1 = { 
    ...
    butn1, 
    imgs2vimgs2vWidget2callback , /* *args, Callback */
    NULL  /* any args */
  };
  ...
  DIX x2 = { 
    ...
    NULL, 
    NULL, 
    NULL,imgs2vimgs2vBrowsercallback , /* *args, Callback  */
    6,  /* Border Offset  */
     22,  /* Scroll width  */
     0,  /* Type  */
     1, /* item highlight */
  ...
  DIT t3 = { 
    ...
    e3,
    1,1,
    NULL,imgs2vimgs2vVideocallback ,0 ,0,18,9 
  };
  ...
  e5[0].fmt = (char *)malloc(9);
  strcpy(e5[0].fmt,(char *)"Xres %4d");
  e5[0].v=(void *)v[2];
  e5[0].sw=1;
  e5[0].noecho=0;
  e5[0].img=NULL;
  e5[1].fmt = (char *)malloc(9);
  strcpy(e5[1].fmt,(char *)"Yres %4d");
  e5[1].v=(void *)v[3];
  e5[1].sw=1;
  e5[1].noecho=0;
  e5[1].img=NULL;
  e5[2].fmt = (char *)malloc(13);
  strcpy(e5[2].fmt,(char *)"ImageTime%7F");
  e5[2].v=(void *)v[4];
  e5[2].sw=1;
  e5[2].noecho=0;
  e5[2].img=NULL;
  DIT t5 = { 
    ...
    e5,
    1,1,
    NULL,imgs2vOptionscallback ,0 ,0,28,20 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t5.Wid,(char *)"Options");
  t5.pt=NULL;
  t5.type = 0;
  t5.item = -1;
  char *menu6[]  = { 
  ...
  DIRA r6 = { 
    ...
    NULL, 
    NULL ,
    NULL,imgs2vFitWidgetcallback , /* *args, Callback  */
    4,  /* Border Offset  */
     22,  /* Scroll width  */
     0,  /* Type  */
     0, /* item highlight */
  ...
  DIL h8 = { 
    ...
    butn8, 
    imgs2vimgs2vWidget9callback ,  /* *args, Callback */
    NULL  /* any args */
  };
  ...
  butn9[0].sw=1;
  strcpy(butn9[0].title,(char *)"Browse");
  butn9[0].xpmn=NULL;
  butn9[0].xpmp=NULL;
  butn9[0].xpmh=NULL;
  butn9[0].bkgr=-1;
  ...
  DIN b9 = { 
    ...
    5,0.500000,0,0,0,1,/* button type and roundinfg factor(0-0.5),bordr,hide ,nodrawbkgr*/ 
    butn9, 
    imgs2vObrowsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  ...
  *d[1].N = b1;
  d[1].N->item = -1;
  imgs2vimgs2vWidget2init(d[1].N,pt) ;
  d[2].t = (DIT *)malloc(sizeof(DIX));
  *d[2].x = x2;
  d[2].x->item = -1;
  imgs2vimgs2vBrowserinit(d[2].x,pt) ;
  ...
  *d[8].h = h8;
  d[8].h->item = -1;
  imgs2vimgs2vWidget9init(d[8].h,pt) ;
...
int imgs2v( void *parent,void **v,void *pt) {
  ...
  GrpId = imgs2vGroup(&D,v,pt);
#else 
  GrpId = Makeimgs2vGroup(&D,pt); // can try this also
#endif 
  d = D.d;
  D.d = d;
  ...
  D.lw = 4;
  D.rw = 4;
  D.xo = 1088;   /* Position of Dialog */ 
  D.yo = 100;
  D.xl = 470;    /*  Length of Dialog */
  D.yl = 398;    /*  Width  of Dialog */
  D.Initfun = imgs2vinit;    /*   init fuction for Dialog */
  D.Cleanupfun = imgs2vcleanup;    /*   cleanup fuction for Dialog */
...
//     D.StackPos = 1; // you may need it
  ...
  Modifyimgs2vGc(&D);    /*  set colors for gui if do not like default*/
  Modifyimgs2v(&D,GrpId);    /*  add extras to  gui*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
void *Runimgs2v(void *parent ,void *args) {
/*************************************************
