...
int kgeditGroup( DIALOG *D,void **v,void *pt) {
  ...
  butn7[0].sw=1;
  strcpy(butn7[0].title,(char *)"!c38Colors");
  butn7[0].xpmn=NULL;
  butn7[0].xpmp=NULL;
  butn7[0].xpmh=NULL;
  ...
  strcpy(b7.Wid,(char *)"KEDcf");
  b7.item = -1;
  BUT_STR  *butn8=NULL; 
  butn8= (BUT_STR *)malloc(sizeof(BUT_STR)*2);
  butn8[0].sw=1;
  strcpy(butn8[0].title,(char *)"Save");
  butn8[0].xpmn=NULL;
  butn8[0].xpmp=NULL;
  butn8[0].xpmh=NULL;
  ...
  strcpy(b9.Wid,(char *)"KEDstrings");
  b9.item = -1;
  BUT_STR  *butn10=NULL; 
  butn10= (BUT_STR *)malloc(sizeof(BUT_STR)*1);
  butn10[0].sw=1;
  strcpy(butn10[0].title,(char *)"!c38Search");
  butn10[0].xpmn=NULL;
  butn10[0].xpmp=NULL;
  butn10[0].xpmh=NULL;
  ...
  strcpy(b10.Wid,(char *)"KEDsearch");
  b10.item = -1;
  BUT_STR  *butn11=NULL; 
  butn11= (BUT_STR *)malloc(sizeof(BUT_STR)*1);
  butn11[0].sw=1;
  strcpy(butn11[0].title,(char *)"!c03Replace");
  butn11[0].xpmn=NULL;
  butn11[0].xpmp=NULL;
  butn11[0].xpmh=NULL;
  ...
  *d[9].N = b9;
  d[9].N->item = -1;
  kgeditKEDstringsinit(d[9].N,pt) ;
  d[10].t = (DIT *)malloc(sizeof(DIN));
  *d[10].N = b10;
  d[10].N->item = -1;
  kgeditKEDsearchinit(d[10].N,pt) ;
