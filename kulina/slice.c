...
int sliceGroup( DIALOG *D,void **v,void *pt) {
  ...
  DIT t0 = { 
    ...
    e0,
    1,1,
    NULL,slicetextbox1callback,1,0,18,9 /* args,Call back */
  };
  strcpy(t0.Wid,(char *)"sliceInput");
  t0.pt=NULL;
  t0.type = 0;
  t0.item = -1;
  T_ELMT *e1  ; 
  ...
  DIT t1 = { 
    ...
    e1,
    1,1,
    NULL,slicetextbox2callback,1,0,18,9 /* args,Call back */
  };
  strcpy(t1.Wid,(char *)"sliceOutput");
  t1.pt=NULL;
  t1.type = 0;
  t1.item = -1;
  BUT_STR  *butn2=NULL; 
  ...
  DIN b2 = { 
    ...
    butn2, 
    slicebutton1callback, /*  Callbak */
      NULL  /* any args */
  };
  strcpy(b2.Wid,(char *)"sliceWidget1");
  b2.item = -1;
  BUT_STR  *butn3=NULL; 
  ...
  DIL h3 = { 
    ...
    butn3, 
    slicesplbutton1callback, /*  Callbak */
      NULL  /* any args */
  };
  strcpy(h3.Wid,(char *)"sliceWidget2");
  h3.item = -1;
  DII i4 = { 
    'i',
    27,125,  
  ...
  strcpy(i4.Wid,(char *)"sliceInfoBox");
  i4.item = -1;
  DIM m5 = { 
    'm',
    22,23,  
  ...
  strcpy(m5.Wid,(char *)"sliceWidget3");
  m5.item = -1;
  DIM m6 = { 
    'm',
    12,57,  
  ...
  strncpy(m6.msg,(char *)"Output Folder",499);
  strcpy(m6.Wid,(char *)"sliceWidget4");
  m6.item = -1;
  T_ELMT *e7  ; 
  e7 =(T_ELMT *)malloc(sizeof(T_ELMT)*1);
  e7[0].fmt = (char *)malloc(4);
  strcpy(e7[0].fmt,(char *)"%5d");
  e7[0].v=(void *)v[2];
  e7[0].sw=1;
  e7[0].noecho=0;
  DIT t7 = { 
    ...
    e7,
    1,1,
    NULL,slicetextbox3callback,1,0,18,9 /* args,Call back */
  };
  strcpy(t7.Wid,(char *)"sliceTime");
  t7.pt=NULL;
  t7.type = 0;
  t7.item = -1;
  DIM m8 = { 
  ...
  strncpy(m8.msg,(char *)"Time slice(secs)",499);
  strcpy(m8.Wid,(char *)"slicePrompt");
  m8.item = -1;
  dtmp = D->d;
  i=0;
  ...
  *d[1].t = t1;
  ...
  slicebutton1init(&b2,pt) ;
  *d[2].N = b2;
  d[2].N->item = -1;
  d[3].t = (DIT *)malloc(sizeof(DIL));
  slicesplbutton1init(&h3,pt) ;
  *d[3].h = h3;
  d[3].h->item = -1;
...
int slice( void *parent,void **v,void *pt) {
  ...
  D.Cleanupfun = slicecleanup;    /*   init fuction for Dialog */
...
//  ModifysliceGc(&(D.gc));    /*  set colors for gui*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
void *Runslice(void *arg) {
/*************************************************
