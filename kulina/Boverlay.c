...
#include "GclrBoverlay.c"
int BoverlayGroup( DIALOG *D,void **v,void *pt) {
  ...
  DIT t0 = { 
    ...
    e0,
    1,1,
    NULL,BoverlayOBinputcallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t0.Wid,(char *)"OBinput");
  t0.pt=NULL;
  t0.type = 1;
  t0.item = -1;
  BUT_STR  *butn1=NULL; 
  ...
  DIN b1 = { 
    ...
    butn1, 
    BoverlayOBinputbrowsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b1.Wid,(char *)"OBinputbrowse");
  b1.item = -1;
  BUT_STR  *butn2=NULL; 
  butn2= (BUT_STR *)malloc(sizeof(BUT_STR)*1);
  butn2[0].sw=1;
  strcpy(butn2[0].title,(char *)"Process Overlay");
  butn2[0].xpmn=NULL;
  butn2[0].xpmp=NULL;
  butn2[0].xpmh=NULL;
  butn2[0].bkgr=-1;
  ...
  DIL h2 = { 
    ...
    butn2, 
    BoverlayOBgocallback ,  /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(h2.Wid,(char *)"OBgo");
  h2.item = -1;
  DII i3 = { 
    'i',
    9,244,  
  ...
  DIT t4 = { 
    ...
    e4,
    1,1,
    NULL,BoverlayOBoutcallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t4.Wid,(char *)"OBout");
  t4.pt=NULL;
  t4.type = 1;
  t4.item = -1;
  BUT_STR  *butn5=NULL; 
  ...
  DIN b5 = { 
    ...
    5,0.150000,0,0,0,1,/* button type and roundinfg factor(0-0.5),bordr,hide ,nodrawbkgr*/ 
    butn5, 
    BoverlayOBOutbrowsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b5.Wid,(char *)"OBOutbrowse");
  b5.item = -1;
  T_ELMT *e6  ; 
  e6 =(T_ELMT *)malloc(sizeof(T_ELMT)*2);
  e6[0].fmt = (char *)malloc(9);
  strcpy(e6[0].fmt,(char *)"Bxres%6d");
  e6[0].v=(void *)v[2];
  e6[0].sw=1;
  e6[0].noecho=0;
  e6[0].img=NULL;
  e6[1].fmt = (char *)malloc(9);
  strcpy(e6[1].fmt,(char *)"Byres%6d");
  e6[1].v=(void *)v[3];
  e6[1].sw=1;
  e6[1].noecho=0;
  e6[1].img=NULL;
  ...
  *d[1].N = b1;
  d[1].N->item = -1;
  BoverlayOBinputbrowseinit(d[1].N,pt) ;
  d[2].t = (DIT *)malloc(sizeof(DIL));
  *d[2].h = h2;
  d[2].h->item = -1;
  BoverlayOBgoinit(d[2].h,pt) ;
  ...
  *d[5].N = b5;
  d[5].N->item = -1;
  BoverlayOBOutbrowseinit(d[5].N,pt) ;
...
*************************************************/
   ...
   *v5 = 1;
   ...
   BoverlaySetup(D,Gpt->arg);
   return GrpId;
}

int Boverlay( void *parent,void **v,void *pt) {
  int ret=1,GrpId,k;
  DIALOG D;
  DIA *d=NULL;
  D.VerId=2107030000;
  ...
  GrpId = BoverlayGroup(&D,v,pt);
#else 
  GrpId = MakeBoverlayGroup(&D,pt); // can try this also
#endif 
  d = D.d;
  D.d = d;
...
#if 1 
  D.Callback = BoverlayCallBack;    /*  default Callback  */
#else 
  D.Callback = NULL;    
#endif
  D.ResizeCallback = BoverlayResizeCallBack;  /*  Resize callback */
#if 0 
  D.WaitCallback = NULL;  /*  Wait callback */
#else 
  D.WaitCallback = BoverlayWaitCallBack;  /*  Wait callback */
#endif
...
//     D.StackPos = 1; // you may need it
  ...
  ModifyBoverlayGc(&D);    /*  set colors for gui if do not like default*/
  ModifyBoverlay(&D,GrpId);    /*  add extras to  gui*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
void *RunBoverlay(void *parent ,void *args) {
/*************************************************
