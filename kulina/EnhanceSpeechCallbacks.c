...
// pt[0] is args passed as inputs; pt[1] is output pointer
  ...
  n = B->nx*B->ny;
  DIT *T,*TO;
  T = (DIT *)kgGetNamedWidget(Tmp,(char *)"ESinput");
  TO = (DIT *)kgGetNamedWidget(Tmp,(char *)"ESoutput");
  n = B->nx*B->ny;
  FileName[0]='\0';
  strcpy(FileName,kgGetString(T,0));
...
void  EnhanceSpeechbutton1init(DIN *B,void *ptmp) {
...
void  EnhanceSpeechsplbutton1init(DIL *B,void *ptmp) {
 void **pt=(void **)ptmp; //pt[0] is arg 
// may use kgChangeButtonNormalImage etc...
 BUT_STR *buts;
 buts = (BUT_STR *) (B->buts);
