...
#include "GclrVtobw.c"
int VtobwGroup( DIALOG *D,void **v,void *pt) {
  ...
  DIT t0 = { 
    ...
    e0,
    1,1,
    NULL,VtobwVBWinputcallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t0.Wid,(char *)"VBWinput");
  t0.pt=NULL;
  t0.type = 1;
  t0.item = -1;
  BUT_STR  *butn1=NULL; 
  ...
  DIN b1 = { 
    ...
    butn1, 
    VtobwVBWinputbrowsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b1.Wid,(char *)"VBWinputbrowse");
  b1.item = -1;
  BUT_STR  *butn2=NULL; 
  ...
  DIL h2 = { 
    ...
    butn2, 
    VtobwVBWgocallback ,  /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(h2.Wid,(char *)"VBWgo");
  h2.item = -1;
  DII i3 = { 
    'i',
    13,180,  
  ...
  DIT t4 = { 
    ...
    e4,
    1,1,
    NULL,VtobwVBWoutcallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t4.Wid,(char *)"VBWout");
  t4.pt=NULL;
  t4.type = 1;
  t4.item = -1;
  BUT_STR  *butn5=NULL; 
  ...
  DIN b5 = { 
    ...
    5,0.150000,0,0,0,1,/* button type and roundinfg factor(0-0.5),bordr,hide ,nodrawbkgr*/ 
    butn5, 
    VtobwVBWOutbrowsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b5.Wid,(char *)"VBWOutbrowse");
  b5.item = -1;
  dtmp = D->d;
  i=0;
  ...
  *d[1].N = b1;
  d[1].N->item = -1;
  VtobwVBWinputbrowseinit(d[1].N,pt) ;
  d[2].t = (DIT *)malloc(sizeof(DIL));
  *d[2].h = h2;
  d[2].h->item = -1;
  VtobwVBWgoinit(d[2].h,pt) ;
  ...
  *d[5].N = b5;
  d[5].N->item = -1;
  VtobwVBWOutbrowseinit(d[5].N,pt) ;
  d[6].t = NULL;
  GrpId=kgOpenGrp(D);
  D->d = dtmp;
  j=0;
...
*************************************************/
   ...
   GrpId = VtobwGroup(D,v,pt);
   Gpt = kgGetWidgetGrp(D,GrpId);
   Gpt->arg= v; // kulina will double free this; you may modify
   VtobwSetup(D,Gpt->arg);
   return GrpId;
}

int Vtobw( void *parent,void **v,void *pt) {
  int ret=1,GrpId,k;
  DIALOG D;
  DIA *d=NULL;
  D.VerId=2107030000;
  ...
  GrpId = VtobwGroup(&D,v,pt);
#else 
  GrpId = MakeVtobwGroup(&D,pt); // can try this also
#endif 
  d = D.d;
  D.d = d;
  ...
  D.Initfun = Vtobwinit;    /*   init fuction for Dialog */
  D.Cleanupfun = Vtobwcleanup;    /*   cleanup fuction for Dialog */
...
#if 1 
  D.Callback = VtobwCallBack;    /*  default Callback  */
#else 
  D.Callback = NULL;    
#endif
  D.ResizeCallback = VtobwResizeCallBack;  /*  Resize callback */
#if 0 
  D.WaitCallback = NULL;  /*  Wait callback */
#else 
  D.WaitCallback = VtobwWaitCallBack;  /*  Wait callback */
#endif
...
//     D.StackPos = 1; // you may need it
  ...
  ModifyVtobwGc(&D);    /*  set colors for gui if do not like default*/
  ModifyVtobw(&D,GrpId);    /*  add extras to  gui*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
void *RunVtobw(void *parent ,void *args) {
/*************************************************
