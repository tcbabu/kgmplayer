...
int ConvertVideoVCinboxcallback(int cellno,int i,void *Tmp) {
  ...
  TO = (DIT *)kgGetNamedWidget(Tmp,(char *)"VCoutbox");
...
int ConvertVideoVCinbrcallback(int butno,int i,void *Tmp) {
  ...
  D = (DIALOG *)Tmp;
  DIT *T,*TO;
  T = (DIT *)kgGetNamedWidget(Tmp,(char *)"VCinbox");
  TO = (DIT *)kgGetNamedWidget(Tmp,(char *)"VCoutbox");
...
void  ConvertVideoVCinbrinit (DIN *B,void *ptmp) {
...
void  ConvertVideoVCradio1init (DIRA *R,void *ptmp) {
 void **pt=(void **)ptmp; //pt[0] is arg 
}
 /* Callback for  VCradio2   */ 
...
//    kgSetGrpVisibility(Tmp,VaspGrp,1);
      kgSetWidgetVisibility(TA,1);
  }
  kgUpdateOn(Tmp);
  return ret;
}
void  ConvertVideoVCradio2init (DIRA *R,void *ptmp) {
 void **pt=(void **)ptmp; //pt[0] is arg 
}
 /* Callback for  VCradio3   */ 
...
//    kgSetGrpVisibility(Tmp,VsizeGrp,1);
      kgSetWidgetVisibility(TX,1);
  }
  kgUpdateOn(Tmp);

  return ret;
}
void  ConvertVideoVCradio3init (DIRA *R,void *ptmp) {
 void **pt=(void **)ptmp; //pt[0] is arg 
}
...
//          strcat(options1,"  -b:v 3000K -aq 0 -c:a libmp3lame ");
          ...
          break;
        case 2:
          strcpy(options1,(char *)"-f mp4 -vcodec libx264 -crf 20  -preset medium  -video_track_timescale 90k");
          strcat(options1,"   -aq 0 -af aresample=44100 -c:a aac  ");
          break;
	default:
        case 3:
          strcpy(options1,(char *)"-f mp4 -vcodec libx264 -crf 22 -preset fast  -video_track_timescale 90k");
...
void  ConvertVideoVconvertinit (DIL *B,void *ptmp) {
 void **pt=(void **)ptmp; //pt[0] is arg 
// may use kgChangeButtonNormalImage etc...
 BUT_STR *buts;
 buts = (BUT_STR *) (B->buts);
}
 /* Callback for  Vconvert   */ 
...
int ConvertVideoVconvertcallback( int butno,int i,void *Tmp) {
  ...
  T = (DIT *)kgGetNamedWidget(Tmp,(char *)"VCinbox");
  TO = (DIT *)kgGetNamedWidget(Tmp,(char *)"VCoutbox");
  TR1 = (DIT *)kgGetNamedWidget(Tmp,(char *)"CVrange");
  TR2 = (DIT *)kgGetNamedWidget(Tmp,(char *)"CVrange");
  TA = (DIT *)kgGetNamedWidget(Tmp,(char *)"CVasp");
  TS = (DIT *)kgGetNamedWidget(Tmp,(char *)"CVxres");
  ...
  cndata.VEndSec= kgGetDouble(TR2,1);
...
void  ConvertVideoVCradio4init (DIRA *R,void *ptmp) {
 void **pt=(void **)ptmp; //pt[0] is arg 
}
 /* Callback for  VCoutbr   */ 
...
void  ConvertVideoVCoutbrinit (DIN *B,void *ptmp) {
 void **pt=(void **)ptmp; //pt[0] is arg 
// may use kgChangeButtonNormalImage etc...
 BUT_STR *buts;
 buts = (BUT_STR *) (B->buts);
