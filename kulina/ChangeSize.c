...
#include "GclrChangeSize.c"
int ChangeSizeGroup( DIALOG *D,void **v,void *pt) {
  ...
  DIT t0 = { 
    ...
    e0,
    1,1,
    NULL,ChangeSizeCSinputcallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t0.Wid,(char *)"CSinput");
  t0.pt=NULL;
  t0.type = 1;
  t0.item = -1;
  BUT_STR  *butn1=NULL; 
  ...
  DIN b1 = { 
    ...
    butn1, 
    ChangeSizeCSinputbrowsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b1.Wid,(char *)"CSinputbrowse");
  b1.item = -1;
  BUT_STR  *butn2=NULL; 
  ...
  DIL h2 = { 
    ...
    butn2, 
    ChangeSizeCSgocallback ,  /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(h2.Wid,(char *)"CSgo");
  h2.item = -1;
  DII i3 = { 
    'i',
    55,239,  
  ...
  DIT t4 = { 
    ...
    e4,
    1,1,
    NULL,ChangeSizeCSoutcallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t4.Wid,(char *)"CSout");
  t4.pt=NULL;
  t4.type = 1;
  t4.item = -1;
  BUT_STR  *butn5=NULL; 
  ...
  DIN b5 = { 
    ...
    5,0.150000,0,0,0,1,/* button type and roundinfg factor(0-0.5),bordr,hide ,nodrawbkgr*/ 
    butn5, 
    ChangeSizeCSOutbrowsecallback , /* *args, Callback */
    NULL  /* any args */
  };
  strcpy(b5.Wid,(char *)"CSOutbrowse");
  b5.item = -1;
  T_ELMT *e6  ; 
  e6 =(T_ELMT *)malloc(sizeof(T_ELMT)*2);
  e6[0].fmt = (char *)malloc(8);
  strcpy(e6[0].fmt,(char *)"Xres%6d");
  e6[0].v=(void *)v[2];
  e6[0].sw=1;
  e6[0].noecho=0;
  e6[0].img=NULL;
  e6[1].fmt = (char *)malloc(8);
  strcpy(e6[1].fmt,(char *)"Yres%6d");
  e6[1].v=(void *)v[3];
  e6[1].sw=1;
  e6[1].noecho=0;
  e6[1].img=NULL;
  DIT t6 = { 
    ...
    e6,
    1,1,
    NULL,ChangeSizeCSRescallback ,0 ,0,18,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  strcpy(t6.Wid,(char *)"CSRes");
  t6.pt=NULL;
  t6.type = 0;
  t6.item = -1;
  DIM m7 = { 
  ...
  *d[1].N = b1;
  d[1].N->item = -1;
  ChangeSizeCSinputbrowseinit(d[1].N,pt) ;
  d[2].t = (DIT *)malloc(sizeof(DIL));
  *d[2].h = h2;
  d[2].h->item = -1;
  ChangeSizeCSgoinit(d[2].h,pt) ;
  ...
  *d[5].N = b5;
  d[5].N->item = -1;
  ChangeSizeCSOutbrowseinit(d[5].N,pt) ;
...
int ChangeSize( void *parent,void **v,void *pt) {
  int ret=1,GrpId,k;
  DIALOG D;
  DIA *d=NULL;
  D.VerId=2107030000;
  ...
  GrpId = ChangeSizeGroup(&D,v,pt);
#else 
  GrpId = MakeChangeSizeGroup(&D,pt); // can try this also
#endif 
  d = D.d;
  D.d = d;
  ...
  D.Initfun = ChangeSizeinit;    /*   init fuction for Dialog */
  D.Cleanupfun = ChangeSizecleanup;    /*   cleanup fuction for Dialog */
...
#if 1 
  D.Callback = ChangeSizeCallBack;    /*  default Callback  */
#else 
  D.Callback = NULL;    
#endif
  D.ResizeCallback = ChangeSizeResizeCallBack;  /*  Resize callback */
#if 0 
  D.WaitCallback = NULL;  /*  Wait callback */
#else 
  D.WaitCallback = ChangeSizeWaitCallBack;  /*  Wait callback */
#endif
...
//     D.StackPos = 1; // you may need it
  ...
  ModifyChangeSizeGc(&D);    /*  set colors for gui if do not like default*/
  ModifyChangeSize(&D,GrpId);    /*  add extras to  gui*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
void *RunChangeSize(void *parent ,void *args) {
/*************************************************
