...
int MakeCutsGroup( DIALOG *D,void **v,void *pt) {
  ...
  strcpy(b1.Wid,(char *)"MakeCutsWidget2");
  b1.item = -1;
  DIM m2 = { 
    'm',
    208,58,  
  ...
  strncpy(m2.msg,(char *)"Cuts info",499);
  strcpy(m2.Wid,(char *)"MakeCutsWidget3");
  m2.item = -1;
  T_ELMT *e3  ; 
  ...
  butn4[0].sw=1;
  strcpy(butn4[0].title,(char *)"Make Cuts");
  butn4[0].xpmn=NULL;
  butn4[0].xpmp=NULL;
  butn4[0].xpmh=NULL;
  ...
  strcpy(h4.Wid,(char *)"MakeCutsWidget11");
  h4.item = -1;
  T_ELMT *e5  ; 
  ...
  strcpy(b6.Wid,(char *)"MakeCutsWidget11");
  b6.item = -1;
  DIM m7 = { 
    'm',
    213,233,  
  ...
  MakeCutsbrowser1init(&x0,pt) ;
  *d[0].x = x0;
  d[0].x->item = -1;
  d[1].t = (DIT *)malloc(sizeof(DIN));
  MakeCutsbutton1init(&b1,pt) ;
  *d[1].N = b1;
  d[1].N->item = -1;
...
//  ModifyMakeCutsGc(&(D.gc));    /*  set colors for gui*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
